      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          <h1 className="text-6xl md:text-8xl font-bold mb-6">
            ...
            <br />
            <span className="text-gray-900 dark:text-white text-4xl md:text-6xl">Crypto & Traditional Markets</span>
          </h1>
        ...
        >
          ...
          <a href="#about" className="border-2 border-primary-600 text-primary-600 hover:bg-primary-600 hover:text-white px-8 py-4 rounded-lg text-lg font-semibold transition-all duration-300 transform hover:scale-105 inline-block">
            About Us
          </a>
        </motion.div>
        ...
        >
          <div className="glass-effect rounded-xl p-6 hover:bg-white/20 transition-all duration-300">
            ...
            <h3 className="text-xl font-semibold mb-2 text-gray-900 dark:text-white">Multi-strategy</h3>
            <p className="text-gray-600 dark:text-gray-300">10-70% annual return across markets and strategies</p>
          </div>
          ...
          <div className="glass-effect rounded-xl p-6 hover:bg-white/20 transition-all duration-300">
            ...
            <h3 className="text-xl font-semibold mb-2 text-gray-900 dark:text-white">AI-Human</h3>
            <p className="text-gray-600 dark:text-gray-300">Empowering innovations through next-generation AI and expert-driven intelligence.</p>
          </div>
        </motion.div>
      </div>
